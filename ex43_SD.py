...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        # Study Drill 2: Asking the first number before the loop breaks things
        # as the guesses count does not reflect this. Below is another way it
        # could have been done, not always the best way.
        success = False
        for i in range(10):
            guess = input("[keypad]> ")
            if code != guess and guess != "win": # Study Drill 4: Cheat Code
                print("BZZZZEDDD!")
            else:
                success = True
                break
